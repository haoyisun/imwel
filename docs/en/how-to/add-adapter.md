# How to add a render adapter

Want imwel to render Artifacts into another AI coding tool’s native on-disk format?

**What you get:** a first-party adapter module registered in this repo via upstream PR — not a drop-in plugin or marketplace install.
...
- Where adapters sit in the pipeline → [Architecture](../explanation/architecture.md)
- Core terms → [Glossary](../explanation/glossary.md)
