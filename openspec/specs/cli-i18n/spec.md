...
Resolve and apply the CLI's interface locale so all user-facing prompts, messages, and errors come from per-locale string tables, independently of scaffold template locale selection.
