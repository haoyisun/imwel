...
- Passive check of the current binding/proposal remotes on CLI invocation (default interval 2 hours; override with `IMWEL_FETCH_THROTTLE_MS`; local edits do not trigger the notice)
...
- Core terms used above → [Glossary](../explanation/glossary.md)
- Manifest fields → [Manifest reference](../reference/manifest.md)
- Full CLI reference → [Commands](../reference/commands.md)
